...
%  plot3( [0 e3(i, 1)], [0 e3(i, 2)], [0 e3(i, 3)], 'k', 'marker', '^');
...
%  plot3( [0 cross(x(1:3), x(4:6))(1)], [0 cross(x(1:3), x(4:6))(2)], [0 cross(x(1:3), x(4:6))(3)], 'b--', "linewidth", 2, 'marker', '^');  
  ...
  plot3( [0 A(x_)(1)], [0 A(x_)(2)], [0 A(x_)(3)], 'r--', "linewidth", 2, 'marker', '^');
  plot3( [0 B(x_)(1)], [0 B(x_)(2)], [0 B(x_)(3)], 'g--', "linewidth", 2, 'marker', '^');
  plot3( [0 G(x_)(1)], [0 G(x_)(2)], [0 G(x_)(3)], 'b--', "linewidth", 2, 'marker', '^');

  xlabel('e1', 'FontSize', 20)
  ylabel('e2', 'FontSize', 20)
  zlabel('e3', 'FontSize', 20)
  e(i, 1:6) = [A(x_)', B(x_)'];  
endfor
return
